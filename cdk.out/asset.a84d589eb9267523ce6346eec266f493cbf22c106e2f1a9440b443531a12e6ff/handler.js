...
export const handler = async (event) => {
  ...
  if (!screenshotBucket || !screenshotKey || !targetUserId) {
  ...
  try {
    ...
    const targetUserIdFromSecret = telegramSecret.targetUserId ?? '';
    const effectiveTargetUserId = targetUserId || targetUserIdFromSecret;
